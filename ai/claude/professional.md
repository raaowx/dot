...
- Languages I regularly use: Swift, Bash, JavaScript/TypeScript (more JS than TS) with Node.
- For a new task, choose the most efficient language for the project context and the task at hand. Efficiency and coherence with the project stack take priority over personal preference.
